...
// Mock Credo 0.7 DIDComm event names and states.
const CredentialEventTypes = { CredentialStateChanged: 'DidCommCredentialStateChanged' };
const CredentialState = { OfferReceived: 'offer-received', CredentialReceived: 'credential-received', Done: 'done' };
const ProofEventTypes = { ProofStateChanged: 'DidCommProofStateChanged' };
const ProofState = { RequestReceived: 'request-received', Done: 'done' };
