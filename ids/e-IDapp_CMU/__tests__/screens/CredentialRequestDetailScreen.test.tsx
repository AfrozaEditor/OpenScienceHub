...
jest.mock('../../src/services/agent', () => ({
    credoAgentService: {
        acceptCredentialOffer: jest.fn(() => Promise.resolve({ success: true })),
        declineCredentialOffer: jest.fn(() => Promise.resolve({ success: true })),
...
describe('CredentialRequestDetailScreen', () => {
    ...
    describe('Component Rendering', () => {
        ...
        it('should render screen title', () => {
            const { getAllByText } = render(<CredentialRequestDetailScreen />);
            expect(getAllByText(/Credential.*Offer|Request/i).length).toBeGreaterThan(0);
        });
