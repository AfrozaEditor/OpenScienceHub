...
jest.mock('../../src/features/deeplink', () => ({
...
jest.mock('../../src/components/RequestModal', () => () => null);
jest.mock('../../src/components/RequestCredentialModal', () => () => null);
jest.mock('../../src/components/ProofRequestModal', () => () => null);
jest.mock('../../src/features/zkp', () => ({
    ZkpRequestModal: () => null,
}));
jest.mock('../../src/screens/QRCodeScreen', () => () => null);
jest.mock('../../src/screens/WebViewScreen', () => () => null);
jest.mock('../../src/screens/MaintenanceScreen', () => () => null);
