...
jest.mock('react-native-base64', () => ({
    encode: (value) => require('buffer').Buffer.from(String(value), 'utf8').toString('base64'),
    decode: (value) => require('buffer').Buffer.from(String(value), 'base64').toString('utf8'),
}));
...
jest.mock('../../src/services/credoCore', () => ({
    ...
    LogLevel: { Fatal: 'fatal', Debug: 'debug', Info: 'info', Warn: 'warn', Error: 'error' },
    CacheModule: jest.fn(),
    DidsModule: jest.fn(),
...
jest.mock('@credo-ts/didcomm', () => ({
    ...
    DidCommCredentialEventTypes: { DidCommCredentialStateChanged: 'DidCommCredentialStateChanged' },
    DidCommCredentialState: {
        OfferReceived: 'offer-received',
        CredentialReceived: 'credential-received',
        Done: 'done',
    },
    DidCommProofEventTypes: { ProofStateChanged: 'DidCommProofStateChanged' },
    DidCommProofState: {
        RequestReceived: 'request-received',
        PresentationSent: 'presentation-sent',
        Done: 'done',
    },
    DidCommConnectionEventTypes: { DidCommConnectionStateChanged: 'ConnectionStateChanged' },
    DidCommDidExchangeState: { Completed: 'completed' },
